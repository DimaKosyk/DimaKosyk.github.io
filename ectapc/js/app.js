(() => {
    ...
    function initSliders() {
        if (document.querySelector(".our-services__slider")) new swiper_core_Swiper(".our-services__slider", {
            ...
            navigation: {
                prevEl: ".our-services__prev",
                nextEl: ".our-services__next"
            },
            breakpoints: {
                600: {
                    slidesPerView: 2,
        ...
        if (document.querySelector(".certificates__swiper")) new swiper_core_Swiper(".certificates__swiper", {
            observer: true,
            observeParents: true,
            slidesPerView: 2.2,
            spaceBetween: 16,
...
***************************************************************************** */
    ...
    document.addEventListener("click", (function(event) {
        const allDropdowns = document.querySelectorAll(".header__languages");
        const activeClass = "language-active";
        allDropdowns.forEach((dropdown => {
            if (dropdown.contains(event.target)) if (dropdown.classList.contains(activeClass)) dropdown.classList.remove(activeClass); else {
                allDropdowns.forEach((d => d.classList.remove(activeClass)));
                dropdown.classList.add(activeClass);
            } else dropdown.classList.remove(activeClass);
        }));
    }));
