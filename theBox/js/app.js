(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".tab-projects__slider")) new swiper_core_Swiper(".tab-projects__slider", {
            ...
            spaceBetween: 32,
            pagination: {
                el: ".tab-projects-pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".tab-projects-button-prev",
                nextEl: ".tab-projects-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
