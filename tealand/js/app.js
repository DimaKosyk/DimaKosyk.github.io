 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".master__slider")) new swiper_core_Swiper(".master__slider", {
            ...
            if (document.querySelector(".blends__slider")) new swiper_core_Swiper(".blends__slider", {
                modules: [ Navigation ],
                speed: 800,
                slidesPerView: 1.5,
                spaceBetween: 10,
                navigation: {
                    prevEl: ".blends-button-prev",
                    nextEl: ".blends-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.5,
            ...
            if (document.querySelector(".our-menu__slider")) new swiper_core_Swiper(".our-menu__slider", {
